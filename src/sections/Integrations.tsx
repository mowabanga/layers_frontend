            ...
            <div className="container">
                <div className="grid lg:grid-cols-2 items-center lg:gap-16">
                    <div>
                        ...
                        <p className="text-white/50 mt-4 text-large">Layers seamlessly connects with your favorite tools making it easy to plug into any workflow and collaborate across platforms.</p>
                    </div>

                    <div>
                        <div className="h-[400px] lg:h-[800px] mt-8 lg:mt-0 md:grid grid-cols-2 gap-4 overflow-hidden [mask-image:linear-gradient(to_bottom, transparent, black_10%, black_90%, transparent)]">
