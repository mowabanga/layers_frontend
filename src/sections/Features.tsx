                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                        ...
                        <div className="aspect-video flex items-center justify-center">
                            ...
                            <Avatar className="-ml-6 border-transparent group-hover:border-green-500 transition">
                                <div className="size-full bg-neutral-700 rounded-full inline-flex items-center justify-center gap-1 relative">
                                    <Image src={avatar4} alt="Avatar r" className="absolute size-full rounded-full opacity-0 group-hover:opacity-100 transition"/>
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center">
                            <p className="text-4xl font-extrabold text-white/20 group-hover:text-white/10 transition duration-500 text-center">We've achieved <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent relative">
                               ...
                               <video src="/gif-incredible.mp4" autoPlay loop muted playsInline className="absolute bottom-full left-1/2 -translate-x-1/2 rounded-2xl shadow-xl opacity-0 group-hover:opacity-100 pointer-events-none transition duration-500"/>
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center gap-4 group">
                            <Key className="w-28 group-hover:outline-lime-400 outline-2 outline-offset-4 outline-transparent outline group-hover:translate-y-1 transition-all duration-500">shift</Key>
                            <Key className="group-hover:outline-lime-400 outline-2 outline-offset-4 outline-transparent outline group-hover:translate-y-1 transition-all duration-500 delay-150">alt</Key>
                            <Key className="group-hover:outline-lime-400 outline-2 outline-offset-4 outline-transparent outline group-hover:translate-y-1 transition-all duration-500 delay-300">C</Key>
                        </div>
                    </FeatureCard>
                </div>
