                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-3 p-2 px-4 md:pr-2 items-center">
                        ...
                        <div className="hidden lg:flex justify-center items-center">
                            <nav className="flex gap-6 font-medium">
                                {navLinks.map((link) => (
                                    <a href={link.href} key={link.label} className="hover:text-gray-300">
                                        {link.label}
                                    </a>
                                ))}
                            </nav>
                        ...
                        <div className="flex justify-end gap-4">
                            <svg 
                                ...
                                className="feather feather-menu hover:cursor-pointer md:hidden"
                            ...
                            <Button variant="secondary" className="hidden md:block">Sign in</Button>
